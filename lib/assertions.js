 ...
 *
 * If you want to test that an object has a non-enumerable property, first
 * check that it has the property with `obj.must.have.property("foo"), then
 * check its enumerableness with `obj.must.not.have.enumerableProperty("foo")`.
 *
 * @method enumerableProperty
 */
exports.enumerableProperty = function(property) {
