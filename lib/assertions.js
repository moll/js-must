...
function eql(a, b) {
  ...
  switch (aType) {
    // Using == to compare literals with their object counterparts.
    ...
    case "object":
      ...
      if (typeof a.valueOf != "function") return false
      if (typeof b.valueOf != "function") return false
      return a.valueOf() === b.valueOf()

    default:
      // Nulls and undefineds are handled above with ===.
      return false
  }
}
...
exports.keys = function(expected) {
  var ok = this.actual && typeof this.actual == "object"
  var keys = ok && enumerableKeys(this.actual)
...
exports.ownKeys = function(expected) {
  var ok = this.actual && typeof this.actual == "object"
  var keys = ok && Object.keys(this.actual)
  ok = ok && eql(keys.sort(), expected.sort())
...
exports.nonenumerable = function(property) {
  var ok = this.actual && typeof this.actual == "object"
  ok = ok && property in this.actual && !isEnumerable(this.actual, property)
