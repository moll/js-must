var defineGetter = require("./").defineGetter
...
function AssertionError(msg, opts) {
   ...
   * @property stack
   */
  var callee = opts && opts.caller || this.constructor
  if (Error.captureStackTrace) Error.captureStackTrace(this, callee)
}
 ...
 * @alias diffable
 */
defineGetter(AssertionError.prototype, "showDiff", function() {
